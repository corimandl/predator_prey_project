...
def get_energy(CMAES_params_sheep, CMAES_params_wolf, pred_prey_worlds):
    ...
    sheep_energy = jnp.mean(pred_prey_worlds.sheep_set.agents.state.content["energy"], axis=0) # mean axis=0 -> (NUM_SHEEP,)
    wolf_energy = jnp.mean(pred_prey_worlds.wolf_set.agents.state.content["energy"], axis=0)
